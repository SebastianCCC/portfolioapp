    ...
    <section id="about" className="text-black dark:text-white p-4 mt-40 w-full">
      <div className="">
        ...
        <div className="w-full">
          <div className="dark:bg-tertiary w-full h-[1px]"></div>
          <div className="flex flex-col mt-4 md:flex-row-reverse justify-center items-start">
            <div className="relative select-none pointer-events-none w-full h-[190px] xl:h-[357px]">
              <Image
                lazyBoundary="0px"
                layout="fill"
                objectFit="cover"
            ...
            <div className="w-full">
              <h3 className="uppercase text-base dark:text-tertiary mt-7 mb-3">Stuff about me</h3>
              <motion.p
                ...
                className="max-w-prose text-sm lg:p-0"
              >
                ...
                computer and I remember it could do anything, and of course I had to play all the
                cool games.
                <>
                  <motion.span
                    initial="closed"
                  ...
                  >
                    ...
                    developing plugins, extensions and addons for popular games like Minecraft, GTA
                    V and Counterstrike. A few months later Discord became a thing and just a year
                    after Discords initial release I joined and discovered robots. And the kid I was
                    didn’t expect the mind-blowing experience of interacting with an API on that
                    scale.
                  </motion.span>
                  <motion.span
                    initial="closed"
                  ...
                  >
                    ...
                    education in front-end, and I can only say that has been one of my best
                    decisions ever. Meeting so many clever people was overwhelming but at the same
                    time just what I needed, and I knew this was it.
                  </motion.span>
                </>
              </motion.p>
