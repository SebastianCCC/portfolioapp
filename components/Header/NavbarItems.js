...
const NavBarItems = ({ link, title, icon }) => {
  ...
  return (
    <li
      className={`group dark:hover:text-white dark:text-secondary text-additional cursor-pointer py-[15px] xl:py-0 tracking-[2px] text-md xl:text-base uppercase xl:capitalize px-4`}
    >
      <Link href={link}>
